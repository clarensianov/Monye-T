                            ...
                            <div class="w-65">
                                <form action="/lupasandi" method="POST">
                                    ...
                                    <div class="form-2 d-none d-flex flex-column mt-3">
                                        ...
                                        <input type="text" class="p-2-5 form-control" id="KataPemulihan" placeholder="Masukkan kata pemulihan Anda" name="kata_pemulihan" value="{{  Session::get('kata_pemulihan') }}">
                                    </div>

                            ...
                            <div class="w-65">
                                <form action="">
                                    <div class="form-1 d-flex flex-column mt-2">
                                        ...
                                        <input type="email" class="p-2-5 form-control" id="Email" placeholder="Masukkan email yang terdaftar" value="{{ Session::get('email') }}" name="email">
                                    </div>

                                    <div class="form-2 d-none d-flex flex-column mt-3">
                                        <label for="KataPemulihan" class="font-14">Kata Pemulihan</label>
                                        <input type="text" class="p-2-5 form-control" id="KataPemulihan" placeholder="Masukkan kata pemulihan Anda" value="{{ Session::get('katapemulihan') }}" name="katapemulihan">
                                    </div>

                                    <div class="form-3 d-none d-flex flex-column mt-3">
                                    ...
                                    <div>
                                        ...
                                        <button style="box-shadow: 0 2px 2px 0 #00000025;" type="submit" class="d-none yellow-button border-0 w-100 mt-3 text-brown font-weight-700 button-layout" onclick="finishSubmit()">Selesai</button>
                                        <div class="BackButton become-pointer d-flex flex-row gap-2 align-items-center mt-3">
                                            ...
                                            <p style="color: #00000065; font-weight:500;" class="m-0">Kembali</p>
                                        </div>
                                    </div>
...
<script>
    function finishSubmit(){
        windows.location.href = "LoginRegister.html";
    }
    ...
    $(document).ready(function(){
        ...
        $(".NextButton").click(function(){
            ...
            $(".circle").css("fill", "#00000025");
            $(".circle").eq(counter-1).css("fill", "#000000");
        });
        ...
        $(".eye-toggle").click(function(){
            ...
            var y = document.getElementById("KonfirmasiKataSandi");
